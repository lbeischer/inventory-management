export default {
  ...
  restocking: {
    ...
    description: 'Set a budget and get urgency-ranked restock recommendations from demand forecasts.',
    ...
    unitCost: 'Unit Cost',
    trend: 'Trend',
    noRecommendations: 'No items with positive demand gap found.',
